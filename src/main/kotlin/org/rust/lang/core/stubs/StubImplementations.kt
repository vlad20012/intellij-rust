...
abstract class RsDocAndAttributeOwnerStubBase<T: RsElement>(
    parent: StubElement<*>?,
    elementType: IStubElementType<*, *>
) : StubBase<T>(parent, elementType), RsDocAndAttributeOwnerStub {

    override val hasDocs: Boolean
        get() = BitUtil.isSet(flags, RsDocAndAttributeOwnerStub.DOCS_MASK)
    override val hasAttrs: Boolean
        get() = BitUtil.isSet(flags, RsDocAndAttributeOwnerStub.ATTRS_MASK)
    override val hasCfg: Boolean
        get() = BitUtil.isSet(flags, RsDocAndAttributeOwnerStub.CFG_MASK)
    override val hasCfgAttr: Boolean
        get() = BitUtil.isSet(flags, RsDocAndAttributeOwnerStub.CFG_ATTR_MASK)
...
class RsExternCrateItemStub(
...
) : RsDocAndAttributeOwnerStubBase<RsExternCrateItem>(parent, elementType),
    RsNamedStub {
    ...
    object Type : RsStubElementType<RsExternCrateItemStub, RsExternCrateItem>("EXTERN_CRATE_ITEM") {
        ...
        override fun createStub(psi: RsExternCrateItem, parentStub: StubElement<*>?) =
            RsExternCrateItemStub(parentStub, this, psi.name, RsDocAndAttributeOwnerStub.prepareData(psi))
...
class RsUseItemStub(
    parent: StubElement<*>?, elementType: IStubElementType<*, *>,
    override val flags: Int
) : RsDocAndAttributeOwnerStubBase<RsUseItem>(parent, elementType) {
    ...
    object Type : RsStubElementType<RsUseItemStub, RsUseItem>("USE_ITEM") {
        ...
        override fun createStub(psi: RsUseItem, parentStub: StubElement<*>?) =
            RsUseItemStub(parentStub, this, RsDocAndAttributeOwnerStub.prepareData(psi))
    }
}
...
class RsStructItemStub(
    ...
    override val name: String?,
    override val flags: Int
) : RsDocAndAttributeOwnerStubBase<RsStructItem>(parent, elementType),
    RsNamedStub {
    ...
    object Type : RsStubElementType<RsStructItemStub, RsStructItem>("STRUCT_ITEM") {
        ...
        override fun createStub(psi: RsStructItem, parentStub: StubElement<*>?): RsStructItemStub {
            var flags = RsDocAndAttributeOwnerStub.prepareData(psi)
    ...
    companion object {
        private val IS_UNION_MASK: Int = makeBitMask(RsDocAndAttributeOwnerStub.USED_BITS + 0)
    }
}
...
class RsEnumItemStub(
    ...
    override val name: String?,
    override val flags: Int
) : RsDocAndAttributeOwnerStubBase<RsEnumItem>(parent, elementType),
    RsNamedStub {
    ...
    object Type : RsStubElementType<RsEnumItemStub, RsEnumItem>("ENUM_ITEM") {
        ...
        override fun createStub(psi: RsEnumItem, parentStub: StubElement<*>?) =
            RsEnumItemStub(parentStub, this, psi.name, RsDocAndAttributeOwnerStub.prepareData(psi))
...
class RsEnumVariantStub(
    ...
    override val name: String?,
    override val flags: Int
) : RsDocAndAttributeOwnerStubBase<RsEnumVariant>(parent, elementType),
    RsNamedStub {
    ...
    object Type : RsStubElementType<RsEnumVariantStub, RsEnumVariant>("ENUM_VARIANT") {
        ...
        override fun createStub(psi: RsEnumVariant, parentStub: StubElement<*>?) =
            RsEnumVariantStub(parentStub, this, psi.name, RsDocAndAttributeOwnerStub.prepareData(psi))
...
class RsModDeclItemStub(
    ...
    override val name: String?,
    override val flags: Int
) : RsDocAndAttributeOwnerStubBase<RsModDeclItem>(parent, elementType),
    RsNamedStub {

    // Macro resolve optimization: stub field access is much faster than PSI traversing
    val hasMacroUse: Boolean
        get() = BitUtil.isSet(flags, HAS_MACRO_USE_MASK)
    ...
    object Type : RsStubElementType<RsModDeclItemStub, RsModDeclItem>("MOD_DECL_ITEM") {
        ...
        override fun createStub(psi: RsModDeclItem, parentStub: StubElement<*>?): RsModDeclItemStub {
            var flags = RsDocAndAttributeOwnerStub.prepareData(psi)
            flags = BitUtil.set(flags, HAS_MACRO_USE_MASK, psi.hasMacroUse)
            return RsModDeclItemStub(parentStub, this, psi.name, flags)
        }
    ...
    companion object {
        private val HAS_MACRO_USE_MASK: Int = makeBitMask(RsDocAndAttributeOwnerStub.USED_BITS + 0)
    }
}
...
class RsModItemStub(
    ...
    override val name: String?,
    override val flags: Int
) : RsDocAndAttributeOwnerStubBase<RsModItem>(parent, elementType),
    RsNamedStub {
    ...
    object Type : RsStubElementType<RsModItemStub, RsModItem>("MOD_ITEM") {
        ...
        override fun createStub(psi: RsModItem, parentStub: StubElement<*>?) =
            RsModItemStub(parentStub, this, psi.name, RsDocAndAttributeOwnerStub.prepareData(psi))
...
class RsTraitItemStub(
    ...
    override val name: String?,
    override val flags: Int
) : RsDocAndAttributeOwnerStubBase<RsTraitItem>(parent, elementType),
    RsNamedStub {
    ...
    companion object {
        private val UNSAFE_MASK: Int = makeBitMask(RsDocAndAttributeOwnerStub.USED_BITS + 0)
        private val AUTO_MASK: Int =   makeBitMask(RsDocAndAttributeOwnerStub.USED_BITS + 1)
    }
}
...
class RsImplItemStub(
    parent: StubElement<*>?, elementType: IStubElementType<*, *>,
    override val flags: Int
) : RsDocAndAttributeOwnerStubBase<RsImplItem>(parent, elementType) {
    object Type : RsStubElementType<RsImplItemStub, RsImplItem>("IMPL_ITEM") {
        ...
        override fun createStub(psi: RsImplItem, parentStub: StubElement<*>?) =
            RsImplItemStub(parentStub, this, RsDocAndAttributeOwnerStub.prepareData(psi))
...
class RsTraitAliasStub(
    ...
    override val name: String?,
    override val flags: Int
) : RsDocAndAttributeOwnerStubBase<RsTraitAlias>(parent, elementType), RsNamedStub {
    ...
    object Type : RsStubElementType<RsTraitAliasStub, RsTraitAlias>("TRAIT_ALIAS") {
        ...
        override fun createStub(psi: RsTraitAlias, parentStub: StubElement<*>?) =
            RsTraitAliasStub(parentStub, this, psi.name, RsDocAndAttributeOwnerStub.prepareData(psi))
...
class RsFunctionStub(
    ...
    val abiName: String?,
    override val flags: Int
) : RsDocAndAttributeOwnerStubBase<RsFunction>(parent, elementType),
    RsNamedStub {
    ...
    object Type : RsStubElementType<RsFunctionStub, RsFunction>("FUNCTION") {
        ...
        override fun createStub(psi: RsFunction, parentStub: StubElement<*>?): RsFunctionStub {
            ...
            var flags = RsDocAndAttributeOwnerStub.prepareData(psi, attrs)
    ...
    companion object {
        private val ABSTRACT_MASK: Int =           makeBitMask(RsDocAndAttributeOwnerStub.USED_BITS + 0)
        private val TEST_MASK: Int =               makeBitMask(RsDocAndAttributeOwnerStub.USED_BITS + 1)
        private val BENCH_MASK: Int =              makeBitMask(RsDocAndAttributeOwnerStub.USED_BITS + 2)
        private val CONST_MASK: Int =              makeBitMask(RsDocAndAttributeOwnerStub.USED_BITS + 3)
        private val UNSAFE_MASK: Int =             makeBitMask(RsDocAndAttributeOwnerStub.USED_BITS + 4)
        private val EXTERN_MASK: Int =             makeBitMask(RsDocAndAttributeOwnerStub.USED_BITS + 5)
        private val VARIADIC_MASK: Int =           makeBitMask(RsDocAndAttributeOwnerStub.USED_BITS + 6)
        private val ASYNC_MASK: Int =              makeBitMask(RsDocAndAttributeOwnerStub.USED_BITS + 7)
        private val HAS_SELF_PARAMETER_MASK: Int = makeBitMask(RsDocAndAttributeOwnerStub.USED_BITS + 8)
        private val IS_PROC_MACRO_DEF: Int =       makeBitMask(RsDocAndAttributeOwnerStub.USED_BITS + 9)
    }
}
...
class RsConstantStub(
    ...
    override val name: String?,
    override val flags: Int
) : RsDocAndAttributeOwnerStubBase<RsConstant>(parent, elementType),
    RsNamedStub {
    ...
    companion object {
        private val IS_MUT_MASK: Int =   makeBitMask(RsDocAndAttributeOwnerStub.USED_BITS + 0)
        private val IS_CONST_MASK: Int = makeBitMask(RsDocAndAttributeOwnerStub.USED_BITS + 1)
    }
}
...
class RsTypeAliasStub(
    ...
    override val name: String?,
    override val flags: Int
) : RsDocAndAttributeOwnerStubBase<RsTypeAlias>(parent, elementType),
    RsNamedStub {
    ...
    object Type : RsStubElementType<RsTypeAliasStub, RsTypeAlias>("TYPE_ALIAS") {
        ...
        override fun createStub(psi: RsTypeAlias, parentStub: StubElement<*>?) =
            RsTypeAliasStub(parentStub, this, psi.name, RsDocAndAttributeOwnerStub.prepareData(psi))
...
class RsNamedFieldDeclStub(
    ...
    override val name: String?,
    override val flags: Int
) : RsDocAndAttributeOwnerStubBase<RsNamedFieldDecl>(parent, elementType),
    RsNamedStub {
    ...
    object Type : RsStubElementType<RsNamedFieldDeclStub, RsNamedFieldDecl>("NAMED_FIELD_DECL") {
        ...
        override fun createStub(psi: RsNamedFieldDecl, parentStub: StubElement<*>?) =
            RsNamedFieldDeclStub(parentStub, this, psi.name, RsDocAndAttributeOwnerStub.prepareData(psi))
...
class RsTypeParameterStub(
    ...
    override val name: String?,
    override val flags: Int
) : RsDocAndAttributeOwnerStubBase<RsTypeParameter>(parent, elementType),
    RsNamedStub {
    ...
    companion object {
        private val IS_SIZED_MASK: Int = makeBitMask(RsDocAndAttributeOwnerStub.USED_BITS + 0)
    }
}
...
class RsConstParameterStub(
    ...
    object Type : RsStubElementType<RsConstParameterStub, RsConstParameter>("CONST_PARAMETER") {
        ...
        override fun createStub(psi: RsConstParameter, parentStub: StubElement<*>?) =
            RsConstParameterStub(parentStub, this, psi.name, RsDocAndAttributeOwnerStub.prepareData(psi))
    }
}
...
class RsValueParameterStub(
    ...
    val patText: String?,
    override val flags: Int
) : RsDocAndAttributeOwnerStubBase<RsValueParameter>(parent, elementType) {
    ...
    object Type : RsStubElementType<RsValueParameterStub, RsValueParameter>("VALUE_PARAMETER") {
        ...
        override fun createStub(psi: RsValueParameter, parentStub: StubElement<*>?) =
            RsValueParameterStub(parentStub, this, psi.patText, RsDocAndAttributeOwnerStub.prepareData(psi))
    }
}
...
class RsSelfParameterStub(
    parent: StubElement<*>?, elementType: IStubElementType<*, *>,
    override val flags: Int
) : RsDocAndAttributeOwnerStubBase<RsSelfParameter>(parent, elementType) {
    ...
    companion object {
        private val IS_MUT_MASK: Int =           makeBitMask(RsDocAndAttributeOwnerStub.USED_BITS + 0)
        private val IS_REF_MASK: Int =           makeBitMask(RsDocAndAttributeOwnerStub.USED_BITS + 1)
        private val IS_EXPLICIT_TYPE_MASK: Int = makeBitMask(RsDocAndAttributeOwnerStub.USED_BITS + 2)
    }
}
...
class RsMacroStub(
    ...
    override val flags: Int
) : RsDocAndAttributeOwnerStubBase<RsMacro>(parent, elementType),
    RsNamedStub {
    ...
    object Type : RsStubElementType<RsMacroStub, RsMacro>("MACRO") {
        ...
        override fun createStub(psi: RsMacro, parentStub: StubElement<*>?) = RsMacroStub(
            ...
            psi.macroBody?.text,
            psi.preferredBraces,
            RsDocAndAttributeOwnerStub.prepareData(psi)
        )
...
class RsMacro2Stub(
    ...
    override val name: String?,
    override val flags: Int
) : RsDocAndAttributeOwnerStubBase<RsMacro2>(parent, elementType),
    RsNamedStub {
    ...
    object Type : RsStubElementType<RsMacro2Stub, RsMacro2>("MACRO_2") {
        ...
        override fun createStub(psi: RsMacro2, parentStub: StubElement<*>?) =
            RsMacro2Stub(parentStub, this, psi.name, RsDocAndAttributeOwnerStub.prepareData(psi))
...
class RsMacroCallStub(
    ...
    override val flags: Int
) : RsDocAndAttributeOwnerStubBase<RsMacroCall>(parent, elementType) {

...
private val MACRO_RANGE_MAP_CACHE_KEY: Key<SoftReference<RangeMap>> = Key.create("MACRO_RANGE_MAP_CACHE_KEY")
...
private fun VirtualFile.writeRangeMap(ranges: RangeMap) {
    ...
    if (getUserData(MACRO_RANGE_MAP_CACHE_KEY)?.get() != null) {
        putUserData(MACRO_RANGE_MAP_CACHE_KEY, SoftReference(ranges))
    }
}
